...
const Modal = ({ setShowModal }) => {
  ...
  return (
    <>
      <div className="my-own-styling overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
        <div className="relative my-6 mx-auto w-11/12 md:w-7/12">
          {/*content*/}
          <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white bg-opacity-90 dark:bg-slate-900 outline-none focus:outline-none">
            {/*header*/}
            <div className="p-5 border-b border-solid border-slate-200 rounded-t">
              <h3 className="text-2xl font-semibold dark:text-slate-400 text-center">
      ...
      <div className="fixed inset-0 z-40 bg-own"></div>
    </>
  );
};
